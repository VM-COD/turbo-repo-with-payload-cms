...
module.exports = {
    ...
    plugins: [
        ...
        function (_a) {
            ...
            var addColorVarsToRoot = function (colorObj, colorGroup) {
                if (colorGroup === void 0) { colorGroup = ''; }
                return Object.entries(colorObj).reduce(function (vars, _a) {
                    var _b;
                    var colorKey = _a[0], value = _a[1];
                    if (typeof value !== 'string') {
                        return vars;
                    }
                    var cssVariable = colorKey === 'DEFAULT' ? "-".concat(colorGroup) : "-".concat(colorGroup, "-").concat(colorKey);
                    var newVars = (_b = {}, _b[cssVariable] = value, _b);
                    return __assign(__assign({}, vars), newVars);
                }, {});
            };
            addBase({
